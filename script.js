$(document).ready(function(){
    ...
    // Evento de clique no botão "Filmes" para transição de página
    $btnFilmes.on('click', function(){
        // Aplica a animação de deslize para a esquerda
        $pageWrapper.css('transform','translateX(-100%)');
        // Aguarda a animação terminar (600ms) e então redireciona para a página de filmes
        setTimeout(function() { 
